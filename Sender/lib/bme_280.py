...
# This code is based on the one designed to work with the BME280_I2CS I2C Mini Module available from ControlEverything.com.
...
device_addr = 118    # 0x76

def get_readings():
    # BME280 address, 0x76(118)
    # Read data back from 0x88(136), 24 bytes
    b1 = i2c.readfrom_mem(device_addr, 0x88, 24)
    ...
    dig_H1 = i2c.readfrom_mem(device_addr, 0xA1, 1)
    dig_H1 = dig_H1[0] # CONVERSION BYTE TO INT

    # BME280 address, 0x76(118)
    # Read data back from 0xE1(225), 7 bytes
    b1 = i2c.readfrom_mem(device_addr, 0xE1, 7)
    ...
    i2c.writeto_mem(device_addr, 0xF2, 0x01)
    # BME280 address, 0x76(118)
    # Select Control measurement register, 0xF4(244)
    #       0x27(39)    Pressure and Temperature Oversampling rate = 1
    #                   Normal mode
    i2c.writeto_mem(device_addr, 0xF4, 0x27)
    # BME280 address, 0x76(118)
    # Select Configuration register, 0xF5(245)
    #       0xA0(00)    Stand_by time = 1000 ms
    i2c.writeto_mem(device_addr, 0xF5, 0xA0)
    ...
    data = i2c.readfrom_mem(device_addr, 0xF7, 8)
